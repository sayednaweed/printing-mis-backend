...
return [
    ...
    'checkout_must_be_before' => "گرفت رفت حاضری باید در میان از وقت ذیل انجام شود:",
    'checkin_must_be_before' => "گرفت امد حاضری باید در میان از وقت ذیل انجام شود:",
    'leave_type_not_found' => "نوع رخصتی پیدا نشد!",
    'shift_not_found' => "شیفت پیدا نشد!",
    'att_dealine_exp' => "مهلت حاضری به پایان رسید.",
];

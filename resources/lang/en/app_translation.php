...
return [
    ...
    'checkin_must_be' => "Check-in must be done between the following time:",
    'checkout_must_be' => "Check-out must be done between the following time:",
    'leave_type_not_found' => "Type of leave not found!",
    'shift_not_found' => "Shift not found!",
    'att_dealine_exp' => "Attendance deadline for submission has expired",
];

...
Route::prefix('v1')->middleware(["authorized:" . 'user:api'])->group(function () {
    ...
    Route::get('/employee/{id}', [EmployeeController::class, "personalDetial"])->middleware(['checkUserAccess', "HasSubPermission:" . HrPermissionEnum::employees->value . "," . SubPermissionEnum::hr_user_information->value . ',' . 'view']);

...
Route::prefix('v1')->middleware(["authorized:" . 'user:api'])->group(function () {
    ...
    Route::get('/employee/{id}', [EmployeeController::class, "personalDetial"])->middleware(['checkUserAccess', "HasSubPermission:" . HrPermissionEnum::employees->value . "," . SubPermissionEnum::hr_employees_information->value . ',' . 'view']);
    ...
    Route::post('/employee/update/information', [EmployeeController::class, 'updateInformation'])->middleware(['checkUserAccess', "HasSubPermission:" . HrPermissionEnum::employees->value . "," . SubPermissionEnum::hr_user_information->value . ',' . 'edit']);

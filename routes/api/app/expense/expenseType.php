...
Route::prefix('v1')->middleware(["authorized:" . 'user:api'])->group(function () {
    ...
    Route::post('/expense-types', [ExpenseTypeController::class, 'store'])->middleware(["HasSubPermission:" . ExpensePermissionEnum::configurations->value . "," . SubPermissionEnum::expense_configuration_expense_type->value . ',' . 'add']);
    Route::put('/expense-types', [ExpenseTypeController::class, 'update'])->middleware(["HasSubPermission:" . ExpensePermissionEnum::configurations->value . "," . SubPermissionEnum::expense_configuration_expense_type->value . ',' . 'edit']);
    ...
    Route::get('/expense-types/icons/{id}', [ExpenseTypeController::class, 'expenseIcons']);
});

...
Route::prefix('v1')->middleware(["authorized:" . 'user:api'])->group(function () {
    ...
    Route::get('/shifts/{id}', [ShiftController::class, "edit"])->middleware(["HasSubPermission:" . HrPermissionEnum::configurations->value . "," . SubPermissionEnum::hr_configuration_shifts->value . ',' . 'add']);
    Route::put('/shifts/{id}', [ShiftController::class, 'update'])->middleware(["HasSubPermission:" . HrPermissionEnum::configurations->value . "," . SubPermissionEnum::hr_configuration_shifts->value . ',' . 'add']);
});
